...
var engine = require('@k4connect/engine.io');
var client = require('@k4connect/socket.io-client');
var clientVersion = require('@k4connect/socket.io-client/package.json').version;
...
Server.prototype.serveClient = function(v){
  ...
  if (v && !clientSource) {
    clientSource = read(require.resolve('@k4connect/socket.io-client/dist/socket.io.min.js'), 'utf-8');
    try {
      clientSourceMap = read(require.resolve('@k4connect/socket.io-client/dist/socket.io.js.map'), 'utf-8');
    } catch(err) {
